...
const screenProvider = ScreenProvider(
  designWidth: 1500, // iPhone14の幅をデザイン基準にする
  designHeight: 844,
  breakpoints: {
...
class ScreenRef {
  ...
  Screen<SizeClass> watch<SizeClass>(
    ...
    final sizeClass = sizeClasses.firstWhere((it) => size.width > it.value);
...
class ResponsiveView extends StatelessWidget {
  ...
  final Widget Function(ScreenSizeClass sizeClass) builder;

  @override
  Widget build(BuildContext context) {
    final screen = ScreenRef(context).watch(screenProvider);
    return builder.call(screen.sizeClass);
  }
}
